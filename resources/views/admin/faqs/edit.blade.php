    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.faqs.update',$faq->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="question" id="i_title" class="form-control{{ $errors->has('question') ? ' is-invalid' : '' }}" value="{{ old('question')??$faq->question }}">
                ...
                <div class="row">
                    <div class="col">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="status" id="i_footer" value="1" @if(old('status')??$faq->status) checked @endif>
            ...
            <div class="form-group">
                ...
                <textarea name="answer" id="i_content" class="form-control{{ $errors->has('answer') ? ' is-invalid' : '' }}">{{ old('answer')??$faq->answer }}</textarea>
