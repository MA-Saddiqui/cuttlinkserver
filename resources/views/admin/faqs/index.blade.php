@section('site_title', formatTitle([__('Faqs'), config('settings.title')]))
...
<div class="d-flex">
    <div class="flex-grow-1">
        <h2 class="mb-3 d-inline-block">{{ __('FAQs') }}</h2>
    </div>
    <div>
        <a href="{{ route('admin.faqs.new') }}" class="btn btn-primary mb-3">{{ __('New') }}</a>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col"><div class="font-weight-medium py-1">{{ __('FAQs') }}</div></div>
            <div class="col-auto">
        ...
        @else
            <div class="list-group list-group-flush my-n3">
                ...
                <div class="mt-3 align-items-center">
                    <div class="row">
                        <div class="col">
                            <div class="mt-2 mb-3">{{ __('Showing :from-:to of :total', ['from' => $faqs->firstItem(), 'to' => $faqs->lastItem(), 'total' => $faqs->total()]) }}
                            </div>
                        </div>
                        <div class="col-auto">
