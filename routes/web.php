...
Route::prefix('/developers')->group(function () {
    ...
    Route::get('/pixels', 'DevelopersController@pixels')->name('developers.pixels');
...
Route::get('/links/export', 'LinksController@linksExport')->middleware('verified')->name('links.export');
...
Route::get('/pixels', 'PixelsController@index')->middleware('verified')->name('pixels');
Route::get('/pixels/new', 'PixelsController@pixelsNew')->middleware('verified')->name('pixels.new');
Route::get('/pixels/edit/{id}', 'PixelsController@pixelsEdit')->middleware('verified')->name('pixels.edit');
...
Route::prefix('/stats/{id}')->group(function () {
    ...
    Route::prefix('/export')->group(function () {
        ...
        Route::get('/platforms', 'StatsController@exportPlatforms')->name('stats.export.platforms');
...
Route::post('/pixels/new', 'PixelsController@createPixel');
Route::post('/pixels/edit/{id}', 'PixelsController@updatePixel');
Route::post('/pixels/delete/{id}', 'PixelsController@deletePixel')->name('pixels.delete');
...
Route::prefix('admin')->middleware('admin', 'license')->group(function () {
    ...
    Route::get('/settings/cronjobs', 'AdminController@settingsCronjobs')->name('admin.settings.cronjobs');
    ...
    Route::get('/pixels', 'AdminController@pixels')->name('admin.pixels');
    Route::get('/pixels/new', 'AdminController@pixelsNew')->name('admin.pixels.new');
    Route::get('/pixels/edit/{id}', 'AdminController@pixelsEdit')->name('admin.pixels.edit');
    ...
    Route::post('/settings/cronjobs', 'AdminController@updateSettingsCronjobs');
    ...
    Route::post('/pixels/new', 'AdminController@createPixel');
    Route::post('/pixels/edit/{id}', 'AdminController@updatePixel');
    Route::post('/pixels/delete/{id}', 'AdminController@deletePixel')->name('admin.pixels.delete');
...
Route::prefix('cronjob')->middleware('cronjob')->group(function () {
    Route::get('cache', 'CronjobController@cache')->name('cronjob.cache');
});
